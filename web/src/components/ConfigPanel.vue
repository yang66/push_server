  ...
  data() {
    return {
      ...
      fieldTips: {
        ...
        'honor.clientId': '荣耀开发者后台"推送服务"页面查看的 Client ID，用于获取认证 Token，与 appId 不同',
        'honor.clientSecret': '荣耀开发者后台"推送服务"页面查看的 Client Secret，用于获取认证 Token，与 appSecret 不同',
        'honor.appSecret': '荣耀推送应用 Secret',
        'honor.badgeClass': '荣耀推送角标类名（可选）',
        'oppo.appKey': 'OPPO 推送 AppKey',
        'oppo.appSecret': 'OPPO 推送 AppSecret',
        'oppo.category': 'OPPO 推送分类标识（可选）',
        'vivo.appId': 'vivo 推送应用 ID',
        'vivo.appKey': 'vivo 推送应用 Key',
        'vivo.appSecret': 'vivo 推送应用 Secret',
        'vivo.category': 'vivo 推送分类标识（可选）',
        'xiaomi.appSecret': '小米推送应用 Secret',
        'xiaomi.channelId': '小米推送渠道 ID（可选）',
        'hm.iss': '请使用服务帐号密钥文件中的sub_account替换',
        'hm.kid': '请使用服务帐号密钥文件中的key_id替换',
        'hm.privateKey': '鸿蒙推送私钥内容，，仅获取 \'-----BEGIN PRIVATE KEY-----\\n\' 和 \'\\n-----END PRIVATE KEY-----\\n\'之间的字符',
        'hm.projectId': '项目 id',
        'hm.supportVoipPush': '是否支持鸿蒙 VoIP 推送，默认 false；只有支持 voip push 之后， 才能接入 callkit，实现后台弹出音视频通话邀请横幅',
